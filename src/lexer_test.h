...
test scan_token_scans_left_square_bracket(void) {
	SCAN_TOKEN_HELPER(TOK_SQUARE_L, "[");
}

test scan_token_scans_right_square_bracket(void) {
	SCAN_TOKEN_HELPER(TOK_SQUARE_R, "]");
}

test scan_token_scans_comma(void) { SCAN_TOKEN_HELPER(TOK_COMMA, ","); }

test scan_token_scans_at_symbol(void) { SCAN_TOKEN_HELPER(TOK_AT, "@"); }
...
void test_lexer_h(void) {
	...
	TEST(scan_token_scans_at_symbol);
